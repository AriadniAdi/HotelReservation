  ...
  describe("#fetchHotels", () => {
      ...
      context("when a valid json is provided", () => {
        it("returns hotels", () => {
            ...
            assert.equal(lakewood.rewards.weekday, 80)
            assert.equal(lakewood.rewards.weekend, 80)
            ...
            assert.equal(bridgewood.rewards.weekday, 110)
            assert.equal(bridgewood.rewards.weekend, 50)
            ...
            assert.equal(ridgewood.rewards.weekday, 100)
            assert.equal(ridgewood.rewards.weekend, 40)
